...
def main():
    ...
    ap.add_argument("--circle", choices=["random","student","student2","student_cpp"], default="random")
    ap.add_argument("--square", choices=["random","student","student2","student_cpp"], default="random")
